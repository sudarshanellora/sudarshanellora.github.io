document.addEventListener("DOMContentLoaded", () => {
  ...
  const techniquesChart = document.getElementById("techniquesChart");
  ...
  window.addEventListener("resize", () => {
    if (skillsChart) Plotly.Plots.resize(skillsChart);
    if (techniquesChart) Plotly.Plots.resize(techniquesChart);
  });
});
